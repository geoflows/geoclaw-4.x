...
%                           - 11 = surface plots for GeoClaw
%                           - 12 = contour plots for GeoClaw
%
...
PlotType = 13;                % type of plot to produce:
...
PlotGrid =  [1 1 0];   % Plot grid lines on each level?

PlotGridEdges =  [0 0 0];  % Plot edges of patches of each grid at
                                 % this level?

%---------------------------------

ContourValues = [1.e-4,2.e-4];       % Set to either a scalar, for automatic contours or
